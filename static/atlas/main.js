import { renderCatalog } from "./catalog.js?v=20260912-3b";
import { createViewer } from "./viewer.js?v=20260912-3b";
import { goToCatalog, goToContent, watchRoute } from "./router.js?v=20260912-3b";
