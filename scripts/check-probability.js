...
import { binomialCoefficient, binomialDistribution, binomialProbability, binomialUpperTail } from "../static/atlas/math/probability.js";
...
assert.equal(binomialProbability(4, 0, 0), 1);
assert.equal(binomialProbability(4, 4, 1), 1);
close(binomialDistribution(8, 0.3).reduce((sum, item) => sum + item.probability, 0), 1, "distribution helper sum");
