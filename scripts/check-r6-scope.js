...
requireCondition(countStatus("implemented") >= 3 && countStatus("implemented") <= 4 && countStatus("planned") === mappings.length - countStatus("implemented") && countStatus("blocked-evidence") === 0, "R6 scope requires the retained pilots plus at most one later pilot and planned remainder");
